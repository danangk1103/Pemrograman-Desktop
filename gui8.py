...
class LoginWindow(QWidget):
    ...
    def clickLoginButton(self):
        ...
        don't, display a warning QMessageBox.""" 
        users = {} 
    ...
    def displayPasswordIfChecked(self, checked):
        ...
        password so others can not see it.""" 
        if checked:
            self.password_edit.setEchoMode(
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        """Create and arrange widgets in the main window.""" 
        image = "C:/Users/Lenovo\Documents/matkul dalam seminggu semester 4/Kamis/Pemrograman Desktop/mcjava.png"
        try:
            with open(image):
